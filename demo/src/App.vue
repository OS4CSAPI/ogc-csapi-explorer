...
const showNav = computed(() => connection.connected || route.name === 'demo' || route.name === 'community' || route.name === 'analytics')
    ...
    <Teleport to="body">
      ...
      <nav v-if="mobileMenuOpen" class="mobile-menu">
        <template v-if="showNav">
          ...
          <button class="mobile-menu-link" @click="mobileNav('/admin')">
            <i class="pi pi-cog"></i> Admin
          </button>
        </template>
