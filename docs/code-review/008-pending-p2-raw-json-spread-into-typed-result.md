...
```typescript
if (typeof json.label !== 'string') throw new Error('PhysicalSystem: label required');
if (typeof json.uniqueId !== 'string') throw new Error('PhysicalSystem: uniqueId required');
const result: PhysicalSystem = {
