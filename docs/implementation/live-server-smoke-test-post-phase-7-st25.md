...
| **P7-F3** — Bare-object wrapping         | RESOLVED (#163) | **Likely testing artifact** _(see correction)_ | Raw curl confirms S1 returns proper arrays — likely always did (see [ST#24 P7-F3 Correction](#st24-p7-f3-correction)) |
