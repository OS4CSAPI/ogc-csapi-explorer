...
| **Authentication** | Basic auth required (`ogc:ogc`) — credentials not stored in repo |
...
| *(none)* | `application/json` | GeoJSON Feature in `{items}` |
...
*Total findings tracked: **90** (F1–F90) across 18 smoke tests spanning Phase 2.1 through Phase 3.16.*
